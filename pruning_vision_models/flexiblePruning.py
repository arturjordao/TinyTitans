...
if __name__ == '__main__':
    ...
    parser.add_argument('--criterion_layer', type=list, default=['L1']) #'rank', 'klDivergence', 'expectedABS', 'random', 'CKA', template_SimilarityMetric
    parser.add_argument('--criterion_filter', type=list,default=['L1']) # 'L1', 'rank', 'klDivergence', 'expectedABS', 'CKA', 'template_SimilarityMetric'
    ...
    while rl.count_res_blocks(neuralNetwork.model) != [2, 2, 2]:
        ...
        func.save_model(neuralNetwork.directory + '/{}_{}_{}_iterations[{}]'.format(neuralNetwork.architecture_name, neuralNetwork.usedCriteria, neuralNetwork.prunedType, i), neuralNetwork.model)
